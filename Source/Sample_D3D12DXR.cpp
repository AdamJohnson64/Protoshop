...
#include "Core_DXGI.h"
#include "Sample.h"
#include "generated.Sample_D3D12DXR.dxr.h"
#include <atlbase.h>
...
class Sample_D3D12DXR : public Sample
{
private:
...
public:
    Sample_D3D12DXR(std::shared_ptr<DXGISwapChain> pSwapChain, std::shared_ptr<Direct3D12Device> pDevice) :
...
std::shared_ptr<Sample> CreateSample_D3D12DXR(std::shared_ptr<DXGISwapChain> pSwapChain, std::shared_ptr<Direct3D12Device> pDevice)
{
    return std::shared_ptr<Sample>(new Sample_D3D12DXR(pSwapChain, pDevice));
}