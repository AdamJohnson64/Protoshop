...
public:
  Direct3D11DeviceImpl() {
    TRYD3D(D3D11CreateDevice(nullptr, D3D_DRIVER_TYPE_HARDWARE, nullptr,
                             D3D11_CREATE_DEVICE_DEBUG, nullptr, 0,
                             D3D11_SDK_VERSION, &pD3D11Device, nullptr,
                             &pD3D11DeviceContext));
  }
  ID3D11Device *GetID3D11Device() { return pD3D11Device; }
  ID3D11DeviceContext *GetID3D11DeviceContext() { return pD3D11DeviceContext; }
