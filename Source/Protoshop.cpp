...
std::shared_ptr<Window> CreateSampleInWindow(
    std::function<std::shared_ptr<Sample>(std::shared_ptr<Window>)>
        createsample) {
...
std::shared_ptr<Window> CreateSampleInWindow(
    std::function<std::shared_ptr<Sample>(HWND)> createsample) {
  return CreateSampleInWindow([&](std::shared_ptr<Window> w) {
