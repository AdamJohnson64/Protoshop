...
std::shared_ptr<Sample> CreateSample_D3D11DrawingContext(std::shared_ptr<DXGISwapChain> swapchain, std::shared_ptr<Direct3D11Device> device);
...
#if VULKAN_INSTALLED
std::shared_ptr<Sample> CreateSample_VKBasic(std::shared_ptr<DXGISwapChain> swapchain, std::shared_ptr<VKDevice> pDeviceVK, std::shared_ptr<Direct3D12Device> pDeviceD3D12);
