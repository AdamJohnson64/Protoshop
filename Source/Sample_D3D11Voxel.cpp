...
public:
  Sample_D3D11Voxel(std::shared_ptr<DXGISwapChain> swapchain,
...
void main(uint3 dispatchThreadId : SV_DispatchThreadID)
{
                            ...
                            D3D11_BIND_CONSTANT_BUFFER, sizeof(Matrix44));
    {
      ...
      }
      {
        ...
        TRYD3D(m_pDevice->GetID3D11Device()->CreateTexture3D(&desc, &descData,
                                                             &m_pTex3DImage.p));
      }
    }
  ...
  void Render() {
    ...
    m_pDevice->GetID3D11DeviceContext()->UpdateSubresource(
        m_pBufferConstants, 0, nullptr, &transform, 0, 0);
